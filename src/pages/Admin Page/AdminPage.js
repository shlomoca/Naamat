            ...
            <div id="APcover" className="cover">
                <div id="mainAPWrapper" className="wrapper">
                    ...
                    <div id="allAdmin">
                        ...
                        <button className="btnhover" type="button" id="feedbackBtn" onClick={() => { getData("feedbackBtn", "feedback", ["name", "email",  "score"],["improvement"]) }}> {Dictionary.adminFeedback} </button>
